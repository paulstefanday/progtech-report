...
const Quote = ({ text, size, direction = "" }) => {
  return (
    <ScrollAnimation animateIn={`fadeIn${direction}`}>
      <Box p={5} pr={0} maxWidth="500px" sx={{ position: "relative", fontFamily: "Rubik" }}>
  ...
  },
  {
    ...
    data: [
      ...
      { text: "GoFundMe", percentage: "6.45%" },
      {
        text: "Other",
        percentage: "6.45%",
        description: "Other: Salesforce, RaisersEdge",
      },
    ],
  },
];
...
const structural = [
  ...
  },
  {
    ...
    subheading: "(e.g. social media or project manager of digital project)",
    data: [
  ...
  },
  {
    ...
    subheading: "(e.g. developer, data scientist)",
    data: [
    ...
    <>
      ...
      <ColorBox end index={2} p={0}>
        ...
        <Box>
          ...
          <Box>
            <Heading>
              <Link variant="link" href="#respondents">2. Who took part in this report?</Link>
            </Heading>
          </Box>
          <Box>
            <Heading>
              <Link href="#tech-stack">
                3. What technology are organisations currently using?
              </Link>
            </Heading>
          </Box>
          <Box>
            <Heading>
              <Link href="#needs-analysis">
                4. Needs Analysis - where are the gaps in progressive tech
              </Link>
            </Heading>
          </Box>
          <Box>
      ...
      <ColorBox end index={3} p={0}>
          ...
          <GraphHeading
            ...
            subheading={() => (
              <>
                ...
                <p>
                  The Progressive Tech Network is in its founding stages - and
                  so we're focussed on learning about our shared needs, and the
                  key interventions we can make through collaboration. When the
                  network launches in late August, members will have access to a
                  library of shared tools, resources and code; training and
                  mentorship programs; and a networked community who work
                  together on solutions to shared challenges.
                </p>
                <p>
                  Read more about who we are and how you can join{" "}
                  <a href="https://progtech.net.au/">here</a>.
                </p>
              </>
            )}
          />
        ...
        <Box width={[1, 1 / 2]} >
          <GraphHeading
          direction="Right"
            text="Why we did this"
            subheading={() => (
              <>
                <p>
                  It’s hard enough to win progressive change. It’s harder when
                  our tech doesn’t work for us, and when we’re trying to solve
                  our common challenges in isolation.
                </p>
                <p>
                  This survey makes the challenges clear: organisations report
                  that they’re constantly reinventing the wheel, operating in
                  silos, using inadequate tools with insufficient skills, making
                  do with minimal investment, that the tech space is
                  exclusionary, that tech staff are often unsupported, and that
                  we’re not doing the long-term movement-wide thinking on tech
                  that we need.
                </p>
                <p>
                  It doesn’t have to be this way. Networks like the Progressive
                  Coders Network (US), the Movement Cooperative (US) and the
                  OPEN Tech Network (international) show us how much we have to
                  gain from working and learning together on tech here in
                  Australia.
                </p>
                <p>
                  But it will take organisations coming together as a network to
                  build the relationships and trust needed for tech
      ...
      <div id="respondents">
        <ColorBox end index={0} p={0}>
          <GraphHeading
            text="Respondents"
            subheading="This report is based off a comprehensive survey that was completed by more than 50 tech/digital staff from across the progressive sector in Australia."
          />

          <Box color="black" width={[1, 1 / 2]} p={5} pt={0}></Box>
        ...
        <ColorBox end index={2} p={0}>
          ...
          <Box color="black" width={[1, 1 / 2]} p={5} pt={0}>
            <p>
              ...
              working as well as we want it to - but what exactly are the
              problems and how widespread are they?
            </p>
            <p>
      ...
      <ColorBox end index={3} p={0}>
        <Flex flexWrap="wrap">
          <Box width={[1, 2 / 5]} pt={[0, 6]} pl={[3]} pr={[3]} >
            <Quote
              size="28px"
          ...
          <ColorBox width={[1, 3 / 5]} index={3} p={2} pt={[0, 6]}>
            <Box
              sx={{
                borderRadius: "25px",
      ...
      <ColorBox end index={0} p={0}>
        <Flex flexWrap="wrap">
          <ColorBox width={[1, 3 / 5]} index={0} p={2} pt={[0, 6]}>
            <Box
              sx={{
                borderRadius: "25px",
                boxShadow: "5px 8px 45px rgb(62 62 62 / 22%)",
      ...
      <ColorBox end index={1} p={0}>
        <Flex flexWrap="wrap">
          <Box width={[1, 2 / 5]} pt={[0, 6]} pl={[0, 2]} pr={[0, 4]}>
            <Quote
              size="23px"
          ...
          <ColorBox width={[1, 3 / 5]} index={1} p={2} pt={[0, 6]}>
            <Box
              sx={{
                borderRadius: "25px",
                boxShadow: "5px 8px 45px rgb(62 62 62 / 22%)",
            ...
            >
              ...
              <p>
                ...
                Both large and small organisations mentioned this as an
                ambition, particularly for building a new custom CRM to suit
                their campaigning and organising needs. Other tools mentioned
                included chatbots, peer-to-peer SMS, realtime monitoring and
                analytics dashboards, as well as automation and AI. Unions in
                particular frequently mentioned custom tech to support members.
              </p>
              <p>
                The second most common response to this question, particularly
                frequent with large organisations,{" "}
                <strong>was better integrating tech tools.</strong>
                <br />
              </p>
              <p>Other ‘wishes’ included:</p>
              <ul>
                <li>Large data analysis projects</li>
                <li>Building more in-house tech capacity</li>
                <li>
                  ‘Doing tech quicker’ to be more responsive, including reducing
                  time it takes to launch actions, respond to external events,
                  identify online leaders and diagnose issues.
                </li>
                <li>Creating an encrypted CRM to improve data security</li>
                <li>
                  Improving organising tech, including distributed local group
                  infrastructure and tools for taking ‘deep care’ of volunteer
                  leaders
                </li>
              </ul>
            </Box>
      ...
      <ColorBox end index={3} p={0}>
        <Flex flexWrap="wrap">
          <ColorBox width={[1, 3 / 5]} index={3} p={2}>
            <Box
              sx={{
                borderRadius: "25px",
                boxShadow: "5px 8px 45px rgb(62 62 62 / 22%)",
          ...
          <Box width={[1, 2 / 5]} pt={[0, 6]} pr={[0, 5]} pl={[0, 4]}>
            <Quote
              size="28px"
      ...
      <div id="solutions">
        <ColorBox end index={2} p={0} pt={[0, 6]}>
          <ScrollAnimation animateIn={`fadeInLeft`} duration={0.5}>
          ...
          <Box color="black" width={[1, 1 / 2]} p={5} pt={0}>
            <p>
              Collectively, we have the tools and capacity to solve the problems
              that we face - and progressive organisations are ready to
            ...
            <p>
              ...
              digital skills they wanted to learn - most of which were skills
              that other participants said they were able to share. The majority
              of organisations want to collaborate but just haven’t had the
      ...
      <ColorBox end index={2} p={0}>
        <Flex flexWrap="wrap">
          <ColorBox width={[1, 1 / 2]} index={2} p={2} pt={[0, 6]} >
            <Box
              sx={{
                borderRadius: "25px",
                boxShadow: "5px 8px 45px rgb(62 62 62 / 22%)",
          ...
          <Box width={[1, 1 / 2]}>
            <BarGraph
              ...
              data={[
                { text: "Lead generation", percentage: "10.0%" },
                ...
                {
                  text: "Running programs for members/vols",
                  percentage: "5.0%",
                },
      ...
      <ColorBox end index={3} p={0}>
        <Flex flexWrap="wrap">
          <Box width={[1, 1 / 2]}>
            <BarGraph
              ...
              data={[
                ...
                {
                  text: "Digital advertising (social media, google ads)",
                  percentage: "41.4%",
                },
                { text: "Digital fundraising", percentage: "34.5%" },
                {
                  text: "Email (list management, delivery)",
                  percentage: "34.5%",
                },
          ...
          <ColorBox width={[1, 1 / 2]} index={3} p={[2]}  pt={[0, 6]} >
            <Box
              sx={{
                borderRadius: "25px",
                boxShadow: "5px 8px 45px rgb(62 62 62 / 22%)",
            ...
            >
              ...
              <ol>
                ...
                <li>
                  <strong>Testing</strong> new tools and solutions
                  collaboratively
                </li>
              </ol>
            </Box>
